...
ConnectionThread::ConnectionThread(std::string user, std::unique_ptr<ConnectionHandler> &&connectionHandler,
                                   std::atomic<bool> &running) : user(std::move(user)), running(running),
