...
struct FilesOwnersDirectoryNotExist : public ServerError {
    ...
    what() const noexcept override { return "Directory for filesOwnsers file doesn't exist!"; }
};

struct FilesOwnersDirectoryNotOpened : public ServerError {
    [[nodiscard]] inline const char *
    what() const noexcept override { return "Directory for filesOwnsers file couldn't be opened!"; }
};
